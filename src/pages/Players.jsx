    ...
    for (const match of matches) {
      for (const team of match.generated_teams || []) {
        for (const player of team.players || []) {
          ...
          map[player.name] = (map[player.name] || 0) + 1;
        }
      }
    }
    return map;
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-emerald-50">
                      ...
                      <TableHead className="font-bold">Games</TableHead>
                        ...
                        <TableRow key={player.id} className="hover:bg-emerald-50 transition-colors">
                          {editingId === player.id ? (
                            ...
                            <>
                              ...
                              <TableCell>
                                {appearanceMap[player.name] ? (
                                  <span className="text-sm font-semibold text-emerald-700">{appearanceMap[player.name]}</span>
                                ) : (
